...
import 'package:flutter_application_inz/pages/add_task_page.dart';
...
import 'package:flutter_application_inz/pages/task_page.dart';

class ManagerHomePage extends StatelessWidget {
  final CookieJar cookieJar;

  const ManagerHomePage({Key? key, required this.cookieJar}) : super(key: key);
  @override
              ...
              child: Wrap(
                ...
                children: [
                  ...
                  _buildCircularButton(
                      context, "Stwórz nowe zadanie", Icons.assignment, () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
